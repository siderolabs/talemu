...
import (
	...
	"github.com/siderolabs/talemu/internal/pkg/machine/kubeconfig"
)
...
func (ctrl *KubernetesSecretsController) updateSecrets(k8sRoot *secrets.KubernetesRootSpec, k8sSecrets *secrets.KubernetesCertsSpec) error {
...
func (ctrl *KubernetesSecretsController) teardownAll(ctx context.Context, r controller.Runtime) error {
