...
require (
	...
	k8s.io/cluster-bootstrap v0.34.0-beta.0 // indirect
	...
	k8s.io/dynamic-resource-allocation v0.34.0-beta.0 // indirect
	k8s.io/endpointslice v0.0.0 // indirect
	k8s.io/externaljwt v0.34.0-beta.0 // indirect
	k8s.io/klog/v2 v2.130.1 // indirect
	k8s.io/kms v0.34.0-beta.0 // indirect
	k8s.io/kube-aggregator v0.34.0-beta.0 // indirect
	k8s.io/kube-openapi v0.0.0-20250710124328-f3f2b991d03b // indirect
	k8s.io/kubelet v0.34.0-beta.0 // indirect
	k8s.io/mount-utils v0.34.0-beta.0 // indirect
	k8s.io/pod-security-admission v0.34.0-beta.0 // indirect
